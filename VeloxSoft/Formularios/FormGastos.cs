...
namespace VeloxSoft.Formularios
{
    public partial class FormGastos : Form
    {
        ...
        public DataGridView dgvGastos => _formTablaGastos.dgvGastos;
        public DataGridView dgvProveedores => _formTablaProveedores.dgvProveedores;
        ...
        private void CrearMiniFormulario()
        {
            ...
            btnGuardarMini.Click += (s, e) =>
            {
                ...
                cbProveedor.Items.Add(txtProveedor.Text.Trim());
                cbProveedor.SelectedItem = txtProveedor.Text.Trim();

                dgvProveedores.Rows.Add(
                    dgvProveedores.Rows.Count + 1,
        ...
        {
            _formTablaGastos = new FormTablaGastos();
            _formTablaProveedores = new FormTablaProveedores();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            dgvGastos.Rows.Add(
                dgvGastos.Rows.Count + 1,
                txtMonto.Text,
                cbProveedor.SelectedItem.ToString()
            );
